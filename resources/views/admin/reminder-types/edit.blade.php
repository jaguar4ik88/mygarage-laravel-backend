...
@section('title', 'Редактировать тип напоминания')
@section('page-title', 'Редактировать тип напоминания')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Редактирование типа напоминания: {{ $reminderType->key }}</h6>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="key" 
                                       name="key" 
                                       value="{{ old('key', $reminderType->key) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="icon" 
                                       name="icon" 
                                       value="{{ old('icon', $reminderType->icon) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="color" 
                                       ...
                                       id="color" 
                                       name="color" 
                                       value="{{ old('color', $reminderType->color) }}" 
                                       required>
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="sort_order" 
                                       name="sort_order" 
                                       value="{{ old('sort_order', $reminderType->sort_order) }}" 
                                       min="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" 
                                   ...
                                   name="is_active" 
                                   value="1" 
                                   {{ old('is_active', $reminderType->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.0.title', $reminderType->translations->where('locale', 'en')->first()->title ?? '') }}" 
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.1.title', $reminderType->translations->where('locale', 'ru')->first()->title ?? '') }}" 
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.2.title', $reminderType->translations->where('locale', 'uk')->first()->title ?? '') }}" 
                                       required>

...
@section('title', 'Создать совет')
@section('page-title', 'Создать совет')
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Новый совет</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.advice-items.store') }}">
                    @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('advice_section_id') is-invalid @enderror" 
                                    ...
                                    @foreach($sections as $section)
                                        <option value="{{ $section->id }}" {{ old('advice_section_id') == $section->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title_uk') is-invalid @enderror" 
                                       id="title_uk" name="title_uk" value="{{ old('title_uk') }}" required>
                                @error('title_uk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('content_ru') is-invalid @enderror" 
                                          id="content_ru" name="content_ru" rows="6" required>{{ old('content_ru') }}</textarea>
                                @error('content_ru')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('content_uk') is-invalid @enderror" 
                                          id="content_uk" name="content_uk" rows="6" required>{{ old('content_uk') }}</textarea>
                                @error('content_uk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

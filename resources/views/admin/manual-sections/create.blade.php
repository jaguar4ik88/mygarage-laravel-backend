...
@section('title', 'Создать секцию мануала')
@section('page-title', 'Создать секцию мануала')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Создание новой секции мануала</h6>
            </div>
                ...
                <form method="POST" action="{{ route('admin.manual-sections.store') }}">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check"></i> Создать секцию
                        </button>
                    </div>
                </form>
            </div>

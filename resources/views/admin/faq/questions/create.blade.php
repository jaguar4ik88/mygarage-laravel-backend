...
@section('title', 'Создать вопрос FAQ')
@section('page-title', 'Создать вопрос FAQ')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Создание нового вопроса FAQ</h6>
            </div>
                ...
                <form method="POST" action="{{ route('admin.faq.questions.store') }}">
                                ...
                                <select class="form-select @error('faq_category_id') is-invalid @enderror" 
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" 
                                                {{ old('faq_category_id', request('category_id')) == $category->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.0.question') }}" 
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.1.question') }}" 
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('translations.2.question') }}" 
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('translations.0.answer') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          required>{{ old('translations.0.answer') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('translations.1.answer') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          required>{{ old('translations.1.answer') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('translations.2.answer') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          required>{{ old('translations.2.answer') }}</textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check"></i> Создать вопрос
                        </button>
                    </div>
                </form>
            </div>

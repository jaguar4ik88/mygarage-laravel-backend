...
@section('title', 'Создать категорию FAQ')
@section('page-title', 'Создать категорию FAQ')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Создание новой категории FAQ</h6>
            </div>
                ...
                <form method="POST" action="{{ route('admin.faq.categories.store') }}">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check"></i> Создать категорию
                        </button>
                    </div>
                </form>
            </div>

...
@section('title', 'Создать секцию советов')
@section('page-title', 'Создать секцию советов')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Новая секция советов</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.advice-sections.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @enderror
                                <div class="form-text">Уникальный идентификатор секции (например: weekly_checks)</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
